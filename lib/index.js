...
import { registerPptsRoutes } from './routes.js';
import { pptsCheckTool, pptsRenderTool, pptsTemplatesTool } from './tools.js';
export { packageRoot };
...
export function apply(ctx, config = {}) {
    ...
    disposers.push(ctx.effect(() => registerPptsRoutes(ctx, {
