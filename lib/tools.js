...
import { TaskStoreError, addArtifact, appendEvent, requireTask, saveOutline, setMaterialStatus, setStatus, updateTask, } from './tasks.js';
export { packageRoot };
    ...
    try {
        ...
        switch (params.action) {
            ...
            case 'material': {
                ...
                if (materialId === '')
                    return { ok: false, message: 'action=material 需要 materialId（Brief 内嵌素材清单中的 id）' };
                ...
                const saved = setMaterialStatus(taskId, materialId, materialStatus, params.detail === undefined ? undefined : String(params.detail));
